...
WebUI.verifyElementVisible(findTestObject('Intermediate/2_Ajax_Form_Submit/icon_mandatory_Name'))

borderName = WebUI.getCSSValue(findTestObject('Intermediate/2_Ajax_Form_Submit/textbox_Name'), 'border')

WebUI.verifyEqual(borderName, '1px solid rgb(255, 0, 0)')