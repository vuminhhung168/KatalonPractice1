...
for (i = 0; i < listData.length; i++) {
	...
	WebUI.click(findTestObject('Intermediate/4_Bootstrap_List_Box/dynamic_default_li_items_in_left', [('item') : listData[i]]))
	
	WebUI.click(findTestObject('Intermediate/4_Bootstrap_List_Box/button_move_right'))
	
	WebUI.verifyElementNotPresent(findTestObject('Intermediate/4_Bootstrap_List_Box/dynamic_default_li_items_in_left', [('item') : listData[i]]), 1)
	
	WebUI.verifyElementPresent(findTestObject('Intermediate/4_Bootstrap_List_Box/dynamic_default_li_items_in_right', [('item') : listData[i]]), 1)
