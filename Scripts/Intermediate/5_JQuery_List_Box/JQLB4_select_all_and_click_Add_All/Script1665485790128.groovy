...
Actions actionPress = new Actions(driver)

//Start pressing CONTROL:
actionPress.keyDown(Keys.CONTROL)

for (i = 0; i < listData.length; i++) {
	WebUI.click(findTestObject('Intermediate/5_JQuery_List_Box/dynamic_items_in_left', ['item' : listData[i]]))
}
WebUI.delay(5)

//Stop pressing CONTROL:
actionPress.keyUp(Keys.CONTROL)
...
//Verification:
for (i = 0; i < listData.length; i++) {
	WebUI.verifyElementNotPresent(findTestObject('Intermediate/5_JQuery_List_Box/dynamic_items_in_left', ['item' : listData[i]]), 2)
	WebUI.verifyElementPresent(findTestObject('Intermediate/5_JQuery_List_Box/dynamic_items_in_right', ['item' : listData[i]]), 2)
}
