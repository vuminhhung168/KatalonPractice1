...
//Verify all items are visible in left panel:
for (int i = 0; i < listData.length; i++) {
    WebUI.verifyElementPresent(findTestObject('Intermediate/5_JQuery_List_Box/dynamic_items_in_left', [('item') : listData[
                i]]), 2)
}

//Verify no item is visible in right panel:
for (int i = 0; i < listData.length; i++) {
    WebUI.verifyElementNotPresent(findTestObject('Intermediate/5_JQuery_List_Box/dynamic_items_in_right', [('item') : listData[
                i]]), 2)
}

WebUI.verifyElementVisible(findTestObject('Intermediate/5_JQuery_List_Box/button_Add'))

WebUI.verifyElementVisible(findTestObject('Intermediate/5_JQuery_List_Box/button_Add_All'))

WebUI.verifyElementVisible(findTestObject('Intermediate/5_JQuery_List_Box/button_Remove'))

WebUI.verifyElementVisible(findTestObject('Intermediate/5_JQuery_List_Box/button_Remove_All'))
